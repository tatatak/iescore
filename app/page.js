    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 flex flex-col gap-4">
        ...
        <Link href="/map" className="block group">
          <div className="bg-white rounded-2xl shadow-xl p-6 flex flex-col items-center gap-3 group-hover:shadow-2xl transition-shadow text-center">
            <Image src="/logo.png" alt="イエスコア" width={1396} height={684} className="h-12 w-auto" priority style={{ width: 'auto' }} />
